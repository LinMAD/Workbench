...
class MovieController extends Controller
{
     ...
     *
     * @Route("/new", name="admin_movies_new")
     * @Method({"GET", "POST"})
     */
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('admin_movies_show', array('id' => $movie->getId()));
        }
     ...
     *
     * @Route("/{id}", name="admin_movies_show")
     * @Method("GET")
     */
     ...
     *
     * @Route("/{id}/edit", name="admin_movies_edit")
     * @Method({"GET", "POST"})
     */
    public function editAction(Request $request, Movie $movie)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('admin_movies_edit', array('id' => $movie->getId()));
        }
     ...
     *
     * @Route("/{id}", name="admin_movies_delete")
     * @Method("DELETE")
     */
    ...
    private function createDeleteForm(Movie $movie)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('admin_movies_delete', array('id' => $movie->getId())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
